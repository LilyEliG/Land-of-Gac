...
public class Person {
	...
	public void eat (Food chocolate) {
	...
	public void give (Thing thing, Person taker) {
		//if thing.getOwner is me, lose thing. Set thing's owner to taker. Taker.possesions adds thing
